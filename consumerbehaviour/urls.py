...
from rbm import views as rbm_views
...
urlpatterns = [
    ...
    path('rbm-upload/',rbm_views.rbm_upload,name='rbm'),
    ...
    path('dataset-upload/', user_views.dataset_upload, name='upload-file'),
    path('createimage/', user_views.create_image, name='create_image'),
